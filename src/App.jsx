...
export default function App() {
  ...
  const exportTasks = () => {
    ...
    if (pendingTasks.length === 0) { alert("Semua tugas udah beres! 🎉"); return; }
    ...
    navigator.clipboard?.writeText(text).then(() => alert("✅ Tugas udah di-copy! Tinggal paste ke grup chat")).catch(() => {});
  };
